...
//..............................................................................
exports.Identity = TempauthIdentity = function (options)
{
...
//..............................................................................
util.inherits(TempauthIdentity, events.EventEmitter2);
util.inherits(TempauthIdentity, Identity);
//..............................................................................
...
var extractAuthorizationFromResponse = function (identity, res)
{
  ...
  //console.log('originalUrl:' + identity.options.url);
    ...
    {
        identity.token.expires = new Date(Date.now() + 60 * 60 * 1000);
    }
...
//..............................................................................
TempauthIdentity.prototype.authorize = function (options, callback)
{
    var self = this;
    //..........................................................................
    //console.log('Intercept TempauthIdentity.prototype.authorize:',self.options);
    ...
    var callback_Request = function (err, response, body)
    {
        ...
        if (err2)
        {
            console.log('TempauthIdentity.authorize.error:',err2);
            callback(err2);
        }
    ...
    //console.log('TempauthIdentity.authorize:',authenticationOptions);
